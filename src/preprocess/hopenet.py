# Copyright 2018 Nataniel Ruiz, Georgia Institute of Technology
#
...
# THIS MODEL AND IT'S WEIGHTS ARE FROM:
# https://github.com/natanielruiz/deep-head-pose (Apache 2.0)
